...
//!
//! Single-channel JSON shape: `{"channel":"<uuid-string>","up_to_ts":<u64>,"marker":"<session_id>"}`
//! Multi-channel JSON shape: `{"v":1,"channels":{"<uuid>":<unix_secs>,...},"marker":"<session_id>"}`
